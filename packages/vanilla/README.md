...
registerGlowTourElements(); const tour = createGlowTour(); const root = document.createElement("glow-tour-root"); root.tour = tour; root.append(document.createElement("glow-tour-overlay"), document.createElement("glow-tour-popover")); document.body.append(root);
